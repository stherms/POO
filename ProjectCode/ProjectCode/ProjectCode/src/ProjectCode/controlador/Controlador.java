...
public class Controlador {
    ...
    public void CrearSocioFederado(int numSocio, String nombre, String nif, String codigoFederacion, String nomFederacion){
        try {
            socioFederadoDAO.crearSocioFederado(numSocio, nombre, nif, codigoFederacion, nomFederacion);
        }
    ...
    public void CrearSocioEstandar(int numSocio, String nombre, String nif, C0_Seguro seguro){
        try {
            socioEstandarDAO.crearSocioEstandar(numSocio, nombre, nif, seguro.getTipoSeguro().toString());
        }
        catch (SQLException ex){
            ex.printStackTrace();
        }
    ...
    public void CrearSocioInfantil(int numSocio, String nombre, int numSocioPadre){
        ...
        try {
            socioInfantilDAO.crearSocioInfantil(numSocio, nombre, numSocioPadre);
        }
        catch (Exception ex){
            ex.printStackTrace();
        }
