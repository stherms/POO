...
public class A_MenuInicial {
    ...
    private void menuSocios() {
        ...
        switch (eleccion) {
            ...
            case 2:
                int numFederado = obtenerEnteroPositivo(teclado," - Número socio: ");
                    teclado.nextLine();
                System.out.println("- Nombre completo: ");
                String nombreFederado = teclado.nextLine();
                System.out.println("- NIF: ");
                String nifFederado = teclado.nextLine();
                System.out.println("Elige una federación del siguiente listado:");
                ...
                int eleccionFederacion = obtenerEnteroPositivo(teclado,"- Selecciona una federación:");
                teclado.nextLine();
                ...
                while(eleccionFederacion<=0 || eleccionFederacion>federaciones.size()){
                    ...
                    eleccionFederacion = obtenerEnteroPositivo(teclado,"- Selecciona una federación:");
                        teclado.nextLine();
                }
                ...
                System.out.println("Socio federado " + nombreFederado + " con número " + numFederado + " ha sido creado");
            ...
            case 3:
                ...
                int numInfantil = obtenerEnteroPositivo(teclado,"- Número socio: ");
                    teclado.nextLine();
                System.out.println("- Nombre Completo: ");
                ...
                int eleccion_padreInfantil =obtenerEnteroPositivo(teclado,"Cuál es el padre o madre del socio infantil?");
                    teclado.nextLine();
                ...
                while(eleccion_padreInfantil<=0 || eleccion_padreInfantil>socioEstandar.size()){
                    ...
                    eleccion_padreInfantil = obtenerEnteroPositivo(teclado,"Cuál es el padre o madre del socio infantil?");
                        teclado.nextLine();
                }
                ...
                System.out.println("Socio infantil " + nombreInfantil + " con número " + numInfantil + " ha sido creado");

                inicio();
                break;
            //CREAR SOCIO ESTÁNDAR
            case 4:               

                int numEstandar = obtenerEnteroPositivo(teclado,"- Número socio:");
                teclado.nextLine();
                ...
                System.out.println("Seguro escogido " + tipoSeguro + " con precio " + precios);
                ...
                System.out.println("Socio estándar " + nombreEstandar + " con número " + numEstandar + " ha sido creado");
            ...
            System.out.println("Seguros disponibles:");
                ...
                int eleccionSeguroS = obtenerEnteroPositivo(teclado,"Selecciona un seguro:");
                    ...
                    System.out.println("Seguro escogido " + tipoSeguroS + " con precio " + preciosS);
